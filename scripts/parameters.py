...
action_key = 'actions'
action_attributes = ['id','name','description','schedule','implementationPhase','responsibleParties','categories','contactPersons','updatedAt']
action_to_action_link_key = 'relatedActions'
indicator_level_key = 'indicatorLevels'
indicator_type_key = 'level'
indicator_key = 'indicator'
indicator_attributes = ['id','name','organization','categories','maxValue','minValue','latestValue']
