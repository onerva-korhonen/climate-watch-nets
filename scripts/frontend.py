...
for municipality_tag in municipality_tags:
    ...
    vis.draw_network(G, node_type_key=node_type_key, node_colors=node_colors, node_markers=node_markers, node_size=node_size, edge_width=edge_width, edge_alpha=edge_alpha, arrow_size=arrow_size, save_path_base=save_path_base, save_name=network_vis_save_name)
